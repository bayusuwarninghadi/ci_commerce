<div class="content">
      <div class="container">
            ...
            <form name="categoryPost" action="/admin/category/edit" method="post">
                  ...
                  <input name="i_depth" type="hidden" value="<?php echo $page->i_depth; ?>">
            ...
            <form name="categoryPost" action="/admin/category/new" method="post">
                  <input name="i_depth" type="hidden" value="0">
...
<script type="text/javascript">
      $(document).ready(function () {
            $('select[name="fk_i_cat_id"]').change(function () {
                  $('input[name="i_depth"]').val($(this).find(':selected').data("depth") + 1);
                  $('input[name="i_parent_id"]').val($(this).val());
            })
      })
</script>