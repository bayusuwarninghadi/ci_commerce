<div class="content container shadow white">
    <div class="pad1">
        ...
        <form action="/register" class="fleft" id="loginForm" method="post" autocomplete="off">
            ...
            <textarea name="s_address" placeholder="Address">value="<?=$s_address?>"</textarea>
            ...
            <input type="text" name="i_rek" class="numeric" placeholder="Bank Account Number" value="<?=$_rek?>">
            <div>
